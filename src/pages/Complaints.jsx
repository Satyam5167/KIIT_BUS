    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 md:px-8 pb-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 text-center md:text-left">
          <h1 className="text-3xl font-bold text-secondary mb-2">File a Complaint</h1>
          <p className="text-slate-500">We take your feedback seriously. Let us know what happened.</p>
        </div>
        ...
        {submitted ? (
          <Card className="text-center py-12 !border-l-4 !border-l-emerald-500 shadow-xl shadow-emerald-100/50">
            ...
            <h3 className="text-2xl font-bold text-secondary mb-2">Complaint Submitted</h3>
            <p className="text-slate-500 mb-6 max-w-md mx-auto">
              Your reference ID is <span className="font-mono font-bold text-slate-800">#CMP-{Math.floor(Math.random() * 10000)}</span>.
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-secondary font-medium appearance-none"
                >
